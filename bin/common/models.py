...
class NeuralNetworkNSA:
    ...
    def generate_detectors(self):
        ...
        # for i in range(10):
            # x = threading.Thread(target=self.generate_detectors_thread, args=(mal_type))
            # threads.append(x)
            # x.start()
    ...
    def generate_detectors_thread(self):
        ...
        while True:
            ...
            rand_samp_type = classes[self.mal_type]
